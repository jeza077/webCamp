                ...
                <form class="form-horizontal" name="guardar-registro" id="guardar-registro-archivo" method="post" action="modelo-invitado.php" enctype="multipart/form-data">
                    <div class="box-body" style="padding:10px 20px;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre_invitado" name="nombre_invitado" placeholder="Ingrese Nombre Invitado" value="<?php echo $invitado['nombre_invitado'] ?>">    
                        </div>

                        <div class="form-group">
                            <label for="apellido_invitado">Apellido:</label>
                            <input type="text" class="form-control" id="apellido_invitado" name="apellido_invitado" placeholder="Ingrese Apellido Invitado" value="<?php echo $invitado['apellido_invitado'] ?>">    
                        </div>

                        <div class="form-group">
                            <label for="biografia_invitado">Biografía</label>
                            <textarea class="form-control" name="biografia_invitado" id="biografia_invitado" rows="10" placeholder="Ingrese Biografía"><?php echo $invitado['descripcion'] ?></textarea>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-info pull-right" id="crear_registro">Guardar</button>
                    </div>
                    <!-- /.box-footer -->
                    </form>
                </div>
