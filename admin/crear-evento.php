...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Crear Evento
        <small>llena el formulario para crear un vento</small>
      </h1>
    </section>
                ...
                <form class="form-horizontal" name="guardar-registro" id="guardar-registro" method="post" action="modelo-evento.php">
                    <div class="box-body" style="padding:10px 20px;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="titulo_evento" name="titulo_evento" placeholder="Ingrese Titulo Evento">    
                        </div>
