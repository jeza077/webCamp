...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editar Evento
        <small>llena el formulario para editar un vento</small>
      </h1>
    </section>
                ...
                <form class="form-horizontal" name="guardar-registro" id="guardar-registro" method="post" action="modelo-evento.php">
                    <div class="box-body" style="padding:10px 20px;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="titulo_evento" name="titulo_evento" placeholder="Ingrese Titulo Evento" value="<?php echo $evento['nombre_evento'] ?>">    
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="invitado" class="form-control select2" style="width:100%;">
                              <option value="0">--Seleccione--</option>
                                <?php
                                  try {
