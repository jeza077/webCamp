        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <table id="registros" class="table table-bordered table-striped" style="width:100%">
                <thead>
                <tr>
                  <th>Nombre</th>
                  <th>Email</th>
                  <th>Fecha Registro</th>
                  <th width="100">Artículos</th>
                  <th>Talleres</th>
                  <th>Regalo</th>
                  <th>Compra</th>
                  <th>Acciones</th>
                                ...
                                <?php
                                    ...
                                    foreach ($articulos as $llave => $articulo) {
                                        if(is_array($articulo) && array_key_exists('cantidad', $articulo)){
                                          echo "<span class='badge bg-blue right'>" .$articulo['cantidad']. "</span>" . " " . $arreglo_articulos[$llave]. "<br>";
                                        } else {
                                          echo "<span class='badge bg-blue right'>$articulo</span>"." " . " " . $arreglo_articulos[$llave]. "<br>";
                                        }
                              ...
                              <td>
                                <?php
                                    ...
                                    while ($eventos = $resultado_talleres->fetch_assoc()) {
                                      ...
                                      // echo $eventos['nombre_evento'] . " " . "<span class='badge bg-blue pull-right'> " . $eventos['fecha_evento'] . " " . $eventos['hora_evento'] . " </span>" . "<br>";
                                    }
                                ?>
                              </td>
